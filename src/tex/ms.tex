...
\begin{abstract}
Test11. We present an automatic approach to discover analytic population models for gravitational-wave (GW) events from data.
...
\end{enumerate}
These prevent \pysr from finding expressions which, despite being low-complexity and high-accuracy, are still uninterpretable to a human scientist due to unusual combinations of operators compared to typical expressions found throughout Test?
